...
rm wkhtmltox.deb; \
echo "INSTALING PHP..........................:"; \
apt -y install php8.2-fpm php8.2-gd php8.2-mbstring php8.2-xml php8.2-curl php8.2-intl php8.2-zip php8.2-soap php8.2-bcmath php8.2-calendar php8.2-exif php8.2-gettext php8.2-mysqli php8.2-pgsql php8.2-mysql php8.2-pgsql php8.2-mongodb && \
